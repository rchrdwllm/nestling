...
const About = () => {
	...
	return (
		<FadeInWrapper>
			<div className="flex flex-col items-center w-full px-2 py-10 space-y-12">
				...
				<div className="bg-white rounded-2xl shadow border p-8 w-full max-w-3xl flex flex-col items-center">
				...
				<Card className="bg-white rounded-2xl shadow border p-8 w-full max-w-4xl flex md:flex-row flex-col justify-between items-center gap-8">
