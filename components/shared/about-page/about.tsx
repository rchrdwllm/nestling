  ...
  return (
    <FadeInWrapper>
      <div className={`flex flex-col items-center w-full px-2 py-10`}>
        ...
        {/* Bottom row of cards */}
        <div className="flex flex-row justify-center gap-8 mx-auto mb-12 w-full max-w-2xl">
        ...
        <div className="flex md:flex-row flex-col justify-center items-center gap-8 mx-auto mb-10 w-full max-w-3xl">
        ...
        <Card className="flex md:flex-row flex-col justify-between items-center gap-8 bg-background mt-4 p-8 rounded-2xl w-full max-w-4xl">
