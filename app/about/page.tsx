...
const missionVision = [
	{
		...
		value: (
			<span>
				To empower educational initiatives with a dedicated platform that enhances
				productivity, collaboration, and efficiency across diverse learning
				projects.
			</span>
		),
	},
...
const AboutStatBox = ({
	...
	return (
		<div
			className={`relative w-full min-w-[260px] max-w-[320px] h-[120px] rounded-2xl p-6 flex flex-col items-center justify-center shadow-md transition-all duration-300 cursor-pointer bg-background border border-[color:var(--border,#e5e7eb)/35] hover:border-primary/60`}
...
const AboutPage = () => {
	...
	if (loading) return <AboutLoadingScreen />;
			...
			<div className="w-full max-w-4xl flex flex-col md:flex-row items-center justify-between gap-8 bg-background border border-[color:var(--border,#e5e7eb)/35] rounded-2xl shadow-md p-8 mt-4">
				<div className="flex-1 flex flex-col gap-2 min-w-[220px] items-center md:items-start">
					...
					<p className="text-base text-muted-foreground mb-2 text-center md:text-left">
						Unit 2103, Orient Square Bldg., F. Ortigas Jr. Rd.,<br />
				...
				{[
					{
						name: "AMERICA",
						flag: (
							<div className="w-[140px] h-[84px] flex items-center justify-center mb-4 overflow-hidden bg-white rounded-lg shadow border border-gray-200">
								<img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" alt="USA Flag" className="w-full h-full object-contain" />
							</div>
						),
						address: (
							<div className="text-center">
								<div className="font-bold text-primary">Leave a Nest America Inc.</div>
								<div className="text-sm text-muted-foreground mt-1 mb-2">3350 Scott Blvd. #5502, Santa Clara, CA 95054</div>
					...
					},
					{
						...
						flag: (
							<div className="w-[140px] h-[84px] flex items-center justify-center mb-4 overflow-hidden bg-white rounded-lg shadow border border-gray-200">
								<img src="https://upload.wikimedia.org/wikipedia/commons/4/48/Flag_of_Singapore.svg" alt="Singapore Flag" className="w-full h-full object-contain" />
							</div>
						),
						address: (
							<div className="text-center">
								<div className="font-bold text-primary">Leave a Nest Singapore Pte. Ltd.<br/>(201026851H)</div>
								<div className="text-sm text-muted-foreground mt-1 mb-2">71 Ayer Rajah Crescent, #06-11/12, Singapore 139951</div>
								<div className="flex justify-center">
									<iframe
					...
					},
					{
						...
						flag: (
							<div className="w-[140px] h-[84px] flex items-center justify-center mb-4 overflow-hidden bg-white rounded-lg shadow border border-gray-200">
								<img src="https://upload.wikimedia.org/wikipedia/commons/6/66/Flag_of_Malaysia.svg" alt="Malaysia Flag" className="w-full h-full object-contain" />
							</div>
						),
						address: (
							<div className="text-center">
					...
					},
					{
						...
						flag: (
							<div className="w-[140px] h-[84px] flex items-center justify-center mb-4 overflow-hidden bg-white rounded-lg shadow border border-gray-200">
								<img src="https://upload.wikimedia.org/wikipedia/en/a/ae/Flag_of_the_United_Kingdom.svg" alt="UK Flag" className="w-full h-full object-contain" />
							</div>
						),
						address: (
							<div className="text-center">
								<div className="font-bold text-primary">Leave a Nest United Kingdom Ltd.</div>
								<div className="text-sm text-muted-foreground mt-1 mb-2">IDEALondon, 69 Wilson St, London EC2A 2BB, UK</div>
								<div className="flex justify-center">
									<iframe
										title="UK Office Map"
					...
					},
					{
						...
						flag: (
							<div className="w-[140px] h-[84px] flex items-center justify-center mb-4 overflow-hidden bg-white rounded-lg shadow border border-gray-200">
								<img src="https://upload.wikimedia.org/wikipedia/en/9/9e/Flag_of_Japan.svg" alt="Japan Flag" className="w-full h-full object-contain" />
							</div>
						),
						address: (
							<div className="text-center">
								<div className="font-bold text-primary">Iidabasimiyuki Bld. (Reception : 4F floor)</div>
								<div className="text-sm text-muted-foreground mt-1 mb-2">1-4, Shimomiyabicho, Shinjuku-ku, Tokyo, 162-0822, Japan</div>
								<div className="flex justify-center">
									<iframe
